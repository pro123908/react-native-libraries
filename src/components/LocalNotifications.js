...
export const NonScheduleNotification = (title, message) => {
  PushNotification.localNotification(notificationProperties(title, message));
};

const notificationProperties = (title, message) => ({
  title, // (optional)
  message, // (required)
